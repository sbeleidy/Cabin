  ...
  <div class="row" data-equalizer data-equalizer-mq="medium-up">
    ...
    <div class="small-12 medium-4 columns">
      <div class="course-meta" data-equalizer-watch>
        ...
        <p><a href="{{ route('course.show', $course->slug) }}">View lessons <i class="fa fa-long-arrow-right"></i></a></p>
      </div>
    </div>
    @endforeach
  </div>
...
<section class="content faq">
  <div class="row">
    ...
    <div class="small-12 columns">
      <h4 class="text-center">More questions? No problem, just shoot an email to <script type="text/javascript">
  //<![CDATA[
  var l=new Array();
